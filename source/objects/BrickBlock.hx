...
class EmptySnowBrickBlock extends FlxSprite
{
    ...
    var brickSnowImage = FlxAtlasFrames.fromSparrow('assets/images/objects/bonus/brick.png', 'assets/images/objects/bonus/brick.xml');
...
class CoinSnowBrickBlock extends FlxSprite
{
    ...
    var snowBrickCoinImage = FlxAtlasFrames.fromSparrow('assets/images/objects/bonus/brick.png', 'assets/images/objects/bonus/brick.xml');
