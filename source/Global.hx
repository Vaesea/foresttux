...
// Softcoded Level support by AnatolyStev (outdated credit, as it's been replaced by a worldmap)
// Carrying over Tux's state support by AnatolyStev
// Worldmap support by AnatolyStev
// Saving and Loading support by AnatolyStev
// Original Global.hx by Discover HaxeFlixel and Vaesea
...
class Global
{
    ...
    public static var tuxWorldmapX:Float = 0;
    public static var tuxWorldmapY:Float = 0;
    ...
    public static var saveName = "ForestWorldM1Save";
